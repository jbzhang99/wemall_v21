...
public class UserManageAction {
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "会员列表", value = "/admin/dietitian_user_list.htm*", rtype = "admin", rname = "会员管理", rcode = "user_manage", rgroup = "会员")
    @RequestMapping({"/admin/dietitian_user_list.htm"})
    public ModelAndView dietitian_user_list(HttpServletRequest request, HttpServletResponse response, String currentPage, String orderBy, String orderType, String condition, String value){
        ModelAndView mv = new JModelAndView("admin/blue/dietitian_user_list.html",
                this.configService.getSysConfig(), this.userConfigService
                .getUserConfig(), 0, request, response);
        UserQueryObject uqo = new UserQueryObject(currentPage, mv, orderBy,
                orderType);
        ...
        CommUtil.saveIPageList2ModelAndView(url + "/admin/dietitian_user_list.htm", "",
                "", pList, mv);
        mv.addObject("userRole", "USER");
        mv.addObject("storeTools", this.storeTools);
